...
int main (void) {
	...
	bt[0] = atoi(strcat(&buff[2], &buff[3]));
	...
	pthread_create(&tid1, NULL, fcfs,  NULL /*&dt_address*/);
	
	/* Shortest Job First Preemptive Scheduling Algorithm */
	pthread_create(&tid2, NULL, sjfPreemptive, NULL /*&dt_address*/);
	
	/* Shortest Job First Non-Preemptive Scheduling Algorithm */
	pthread_create(&tid3, NULL, sjfNon,  NULL /*&dt_address*/);
